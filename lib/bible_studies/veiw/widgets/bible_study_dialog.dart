...
class BibleStudyDialog extends StatefulWidget {
  final String type;
  final BibleStudyModel model;
  final int cellKey;
  BibleStudyDialog(this.type, {required this.model, required this.cellKey});

  @override
  _BibleStudyDialogState createState() => _BibleStudyDialogState();
}

class _BibleStudyDialogState extends State<BibleStudyDialog> {
