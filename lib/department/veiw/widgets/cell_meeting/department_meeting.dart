...
class AddDepartmentMeeting extends StatefulWidget {
  final String cell;
  AddDepartmentMeeting(this.cell);

  @override
  _AddDepartmentMeetingState createState() => _AddDepartmentMeetingState();
}

class _AddDepartmentMeetingState extends State<AddDepartmentMeeting> {
