...
import 'package:church_app/home_cell/controller/cell_meeting_controller.dart';
...
class AddCellMeeting extends StatefulWidget {
  final String cell;
  AddCellMeeting(this.cell);

  @override
  _AddCellMeetingState createState() => _AddCellMeetingState();
}

class _AddCellMeetingState extends State<AddCellMeeting> {
                      ...
                      ElevatedButton(
                        onPressed: () {
                          if (formKey.currentState.validate()) {
                            ...
                            CellMeetingController().addCellMeeting(model);
